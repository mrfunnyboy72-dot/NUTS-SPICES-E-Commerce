...
export const PRODUCTS = [
  ...
  {
    id: 'dt-01',
    name: 'Royal Kimia Bam Dates (Khajoor)',
    category: 'dates',
    categoryName: 'DATES',
    badge: 'Fresh Harvest',
    rating: 4.9,
    ...
    description: 'Soft, melt-in-the-mouth Kimia dates from Bam. 100% natural without added sugar.',
    origin: 'Iran',
    shelfLife: '9 Months'
  },
  {
    id: 'dt-02',
    name: 'Premium Ajwa Al-Madinah Dates',
    category: 'dates',
    categoryName: 'DATES',
    badge: 'Holy Harvest',
    rating: 5.0,
    ...
    description: 'Authentic dark Ajwa dates from Madinah, known for health benefits and high energy.',
    origin: 'Saudi Arabia',
    shelfLife: '12 Months'
  },
